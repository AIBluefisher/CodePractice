...
| [44. Wildcard Matching](https://leetcode.com/problems/wildcard-matching/)  | - | - | ```dynamic programming``` | - | <input type="checkbox"> |
| [45. Jump Game II](https://leetcode.com/problems/jump-game-ii/)  | - | - | ```array``` | - | <input type="checkbox"> |
